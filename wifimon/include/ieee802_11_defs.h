...
#define HE_PHYCAP_CHANNEL_WIDTH_MASK ((u8)(BIT(1) | BIT(2) | BIT(3) | BIT(4)))
...
#define HE_OPERATION_DFLT_PE_DURATION_MASK ((u32)(BIT(0) | BIT(1) | BIT(2)))
#define HE_OPERATION_DFLT_PE_DURATION_OFFSET 0
#define HE_OPERATION_TWT_REQUIRED ((u32)BIT(3))
#define HE_OPERATION_RTS_THRESHOLD_MASK                                        \
  ((u32)(BIT(4) | BIT(5) | BIT(6) | BIT(7) | BIT(8) | BIT(9) | BIT(10) |       \
...
#define HE_OPERATION_BSS_COLOR_MASK                                            \
  ((u32)(BIT(24) | BIT(25) | BIT(26) | BIT(27) | BIT(28) | BIT(29)))
...
/* HE QoS Info field */
#define HE_QOS_INFO_EDCA_PARAM_SET_COUNT                                       \
  ((u8)(BIT(0) | BIT(1) | BIT(2) | BIT(3)))

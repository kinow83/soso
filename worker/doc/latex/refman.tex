...
\input{namespacesoso}
\chapter{클래스 문서화}
\input{classsoso_1_1Job}
\input{classsoso_1_1Worker}
\input{classsoso_1_1WorkerManager}
\input{classsoso_1_1WorkerManager2}
\chapter{파일 문서화}
\input{worker_8h}
\input{job_8cpp}
\input{worker_8cpp}
\input{worker__manager_8cpp}
\input{worker__manager2_8cpp}
